...
# Specify cross compilers and tools for embedded software compilation
...
file(GLOB_RECURSE SOURCES "src/*.c" "AutoGenerated.X/*.c" "lib/FreeRTOS/*.c" "lib/RTT/*.c")

add_executable(${PROJECT_NAME}.elf ${SOURCES} ${LINKER_SCRIPT})
target_link_libraries(${PROJECT_NAME}.elf attitude)
